...
<div class="card" style="padding: 20px;">
    ...
    <?php if ($pending_inventory > 0): ?>
        ...
        <p><a href="approvals.php?view=inventory" class="btn primary"><i class="fas fa-external-link-alt"></i> Go to Inventory Approvals</a></p>
    <?php else: ?>
...
<div class="card" style="padding: 20px;">
    <h3 class="h3"><i class="fas fa-clipboard-list"></i> Stock Request Approvals</h3>
