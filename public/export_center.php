...
<div class="card" style="padding: 30px;">
    ...
    <?php elseif ($active_tab === 'financial'): ?>
        ...
        <form method="post" action="reports.php" style="margin-bottom: 30px;">
    ...
    <?php elseif ($active_tab === 'inventory'): ?>
        ...
        <form method="post" action="inventory_history.php" style="margin-bottom: 30px;">
    ...
    <?php elseif ($active_tab === 'staff'): ?>
        ...
        <form method="post" action="staff_reports.php" style="margin-bottom: 30px;">
            <input type="hidden" name="export" value="1">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-bottom: 20px;">
                <div>
                    <label style="font-weight: bold; display: block; margin-bottom: 5px;">Start Date</label>
