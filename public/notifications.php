...
// Only allow admin, manager, and superadmin
...
try {
    ...
    $sample_notifications = [
        ['user_id' => $me['id'], 'type' => 'success', 'title' => 'Export Completed', 'message' => 'User audit logs exported successfully'],
        ['user_id' => $me['id'], 'type' => 'warning', 'title' => 'Low Stock Alert', 'message' => '5 items are running low on stock'],
        ['user_id' => $me['id'], 'type' => 'error', 'title' => 'Failed Login Attempt', 'message' => 'Multiple failed login attempts detected'],
        ['user_id' => $me['id'], 'type' => 'info', 'title' => 'System Update', 'message' => 'New system features available']
    ];
...
<div class="notifications-container">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Manage your system notifications and alerts</p>
    </div>
