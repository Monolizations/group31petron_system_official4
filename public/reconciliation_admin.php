...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="workflow-steps">
                    <div class="step">
                        <h4><span class="step-number">1</span> Staff Records</h4>
                        <p>Staff enters pump readings at shift end</p>
                    </div>
                    <div class="step">
                        <h4><span class="step-number">2</span> Manager Verifies</h4>
                        <p>Manager validates & approves records</p>
                    </div>
                    <div class="step">
                        <h4><span class="step-number">3</span> Admin Finalizes</h4>
                        <p>You enter physical stock & lock with password</p>
                    </div>
                    <div class="step">
                        <h4><span class="step-number">4</span> Export Reports</h4>
                        <p>Generate Excel/PDF for compliance</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <span class="step-number" style="background: white; color: #667eea; border: 2px solid #667eea;">1-2</span>
        ...
        <?php if ($selected_recon): ?>
            <div class="card">
                <div class="card-header">
                    <span class="step-number" style="background: white; color: #667eea; border: 2px solid #667eea;">3</span>
        ...
        <div class="card">
            <div class="card-header">
                <span class="step-number" style="background: white; color: #667eea; border: 2px solid #667eea;">4</span>
