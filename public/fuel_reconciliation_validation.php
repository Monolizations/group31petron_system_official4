        ...
        <div class="fr-card">
          ...
          <div class="fr-card-body">
            ...
            <div class="fr-calc-box">
              ...
              <div class="fr-calc-result" style="font-size: 14px;">= Total Value: ₱<?php echo number_format((($rec['current_reading'] - $rec['previous_reading']) - ($rec['calibration'] ?? 0)) * 65.50, 2); ?></div>
            </div>
