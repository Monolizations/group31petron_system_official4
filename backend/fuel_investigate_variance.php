...
if (!in_array($me['role'], ['admin', 'superadmin'])) {
    ...
    echo '<div class="alert alert-danger">Access denied. Only administrators can investigate variances.</div>';
    exit;
}
...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" form="investigateVarianceForm" class="btn btn-primary" id="submitBtn">
